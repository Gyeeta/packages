...
if [ $# -lt 3 ]; then
	echo -e "\nUsage : $0 <DB Data directory path> <DB 'postgres' user Password> <Postgres Port to Listen on> <Optional DB Max Shared buffers in MB>\n\n"
	echo -e "For example, $0 /opt/gyeeta/postgresdb/data myPassword 10040\n"
